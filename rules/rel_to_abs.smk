rule rel_to_abs:
    input:
        rds=OUT_DIR+"sWGS_fitting/{project}_{bin}kb/absolute_POST_down_sampling/relative_cn_rds/{project}_{bin}kb_relSmoothedCN.rds",
    ...
    params:
        ...
        bin="{bin}"
    shell:
        "Rscript scripts/qdnaseq_rel_to_abs.R {input.rds} {input.meta} {params.outdir} {params.bin} {params.project}"
