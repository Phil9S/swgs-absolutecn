rule combine_results:
    ...
    output:
        tsv=OUT_DIR
        + "sWGS_fitting/{project}_{bin}kb/absolute_POST_down_sampling/{project}_{bin}kb_ds_abs_fits.tsv",
        rds=OUT_DIR
        + "sWGS_fitting/{project}_{bin}kb/absolute_POST_down_sampling/{project}_{bin}kb_ds_absCopyNumber.rds",
        tab=OUT_DIR
        + "sWGS_fitting/{project}_{bin}kb/absolute_POST_down_sampling/{project}_{bin}kb_ds_absCopyNumber_segTable.tsv",
    log:
